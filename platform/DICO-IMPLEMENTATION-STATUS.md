...
| B6R — final asset & motion system | **IN PROGRESS — B6R.1 AUDIT DONE** | `platform/DICO-FINAL-ASSET-MANIFEST.md`. El personaje nuevo (aro azul, sin galera, 2D sin boca) esta definido pero NO existe como asset de produccion: las 10 poses 3D nuevas vienen sobre negro opaco y el recorte por luminancia no es viable porque el 47,9% de la zona central tambien es casi-negro. El Dico 2D y el isologo solo existen como laminas de presentacion. Bloqueado en re-export con alfa. |
